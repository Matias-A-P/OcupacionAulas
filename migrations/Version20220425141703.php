...
final class Version20220425141703 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aulas (id INT AUTO_INCREMENT NOT NULL, id_edificio_id INT NOT NULL, id_piso_id INT DEFAULT NULL, aula VARCHAR(100) NOT NULL, capacidad INT DEFAULT NULL, INDEX IDX_CAB6B16A9277E621 (id_edificio_id), INDEX IDX_CAB6B16AC45599DF (id_piso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ocupacion (id INT AUTO_INCREMENT NOT NULL, id_aula_id INT NOT NULL, id_catedra_id INT DEFAULT NULL, id_area_id INT DEFAULT NULL, user_id INT DEFAULT NULL, fecha DATE NOT NULL, hora_inicio TIME NOT NULL, hora_fin TIME NOT NULL, comision INT NOT NULL, rep_semanal TINYINT(1) DEFAULT 0 NOT NULL, rep_fecha_fin DATE DEFAULT NULL, rep_id_padre INT DEFAULT 0, observaciones VARCHAR(255) DEFAULT NULL, INDEX IDX_C6DC2467387BB25 (id_aula_id), INDEX IDX_C6DC246CCB14CBA (id_catedra_id), INDEX IDX_C6DC2466392E9EC (id_area_id), INDEX IDX_C6DC246A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, dni INT NOT NULL, nombre VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D6497F8F253B (dni), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
